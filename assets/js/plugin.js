	  	...
	  	editor.addButton( 'zps_button', {
            ...
            menu: [
				...
				{ // Client Carousel
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {								
								editor.insertContent( '[client_carousel name="'+e.data.name+'" autoplay="'+e.data.autoplay+'" items="'+e.data.items+'" ][client_item image="" link="" target="" ][/client_item][/client_carousel]');								
                            }
                        });
                    }	
				},
				...
				{ // Testimonial Shortcode
                    ...
                    onclick: function() {
						editor.insertContent( '[testimonial_wrap][testimonial_item author="" ] YOUR CONTENT HERE [/testimonial_wrap]');
                    }	
				}
           ]
        });
