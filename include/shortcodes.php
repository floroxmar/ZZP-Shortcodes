...
if ( !function_exists( 'zps_testimonial_item' )){
	function zps_testimonial_item( $atts, $content = null ){
		...
		return '<div class="testimonial_item"><div class="testimonial_content"><p>'.do_shortcode( $content ).'</p></div><h4>'.$author.'</h4></div>';		
	}
 ...
 function zp_client_carousel( $atts, $content = null ){
	...
	jQuery(document).ready(function() {
	  ...
	  jQuery(window).load(function() {
		  var nav_height = jQuery(".owl-carousel .owl-item").height();
		  jQuery(".client_carousel_nav").css({"margin-top": nav_height/2+"px" });
		  jQuery(".client_carousel_nav").show();	 
	  });
	</script>';
	return '<div class="client_carousel"><div class="container">'.$output.'<a class="client_carousel_nav cc_prev"><span class="glyphicon glyphicon-chevron-left"></span></a><div id="'.$name.'" class="owl-carousel">'.do_shortcode( $content ).'</div><a class="client_carousel_nav cc_next"><span class="glyphicon glyphicon-chevron-right"></span></a></div></div>';
 }
