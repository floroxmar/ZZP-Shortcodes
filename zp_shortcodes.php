...
class ZZP_Shortcodes {
	...
	function zps_shortcode_frontend(){
		...
		wp_register_style( 'owl_carousel', ZPS_PLUGIN_URL .'assets/css/owl.carousel.css' );
		wp_register_style( 'owl_carousel_transition', ZPS_PLUGIN_URL.'assets/css/owl.transitions.css' );
